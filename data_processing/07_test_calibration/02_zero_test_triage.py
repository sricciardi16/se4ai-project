...
TARGET_PROJECTS = ["stegano", "pypdf"]
RUN_ID = "1"  # Hardcoded to look at the first baseline run

def main():
    env_setup.EXP_02_TRIAGE_DIR.mkdir(parents=True, exist_ok=True)
    ...
    for project_name in TARGET_PROJECTS:
        ...
        # Initialize Chase
        chase_worker = Chase(profile="02_zero_test_triage", session_id=project_name)
        ...
        print(f"  [SUCCESS] Analysis saved to {env_setup.EXP_02_TRIAGE_DIR.name}/{project_name}.md")
